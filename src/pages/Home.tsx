      ...
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        >
          ...
          <button
            ...
            className="overflow-hidden relative w-30 p-2 h-15 bg-[#43e97b] text-white border-none rounded-md text-lg font-bold cursor-pointer z-10 group"
          >
            TEST IT!
            ...
            <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-2.5 left-1/2 transform -translate-x-1/2 z-10">
              Explore!
            </span>
          </button>
        </motion.div>
